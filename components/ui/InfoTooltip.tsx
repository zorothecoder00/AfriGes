...
export default function InfoTooltip({ text }: { text: string }) {
  return (
    <span className="group/tip relative inline-flex align-middle ml-1">
      ...
      <span className="pointer-events-none absolute z-30 bottom-full left-1/2 -translate-x-1/2 mb-2 w-52 max-w-[70vw] rounded-lg bg-slate-800 text-white text-[11px] leading-snug px-2.5 py-1.5 text-left font-normal normal-case tracking-normal opacity-0 scale-95 group-hover/tip:opacity-100 group-hover/tip:scale-100 group-focus-within/tip:opacity-100 group-focus-within/tip:scale-100 transition-all duration-150 shadow-lg">
        {text}
