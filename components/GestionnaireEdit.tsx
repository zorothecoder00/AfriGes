          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="mb-6">
              ...
              <input
                ...
                disabled={formData.googleOnly}
                className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all disabled:bg-gray-100 disabled:opacity-60"
            ...
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">
                  ...
                  Réactiver un mot de passe se fait en renseignant à nouveau un mot de passe ci-dessus.
                </p>
              </div>
            </label>
          </div>
