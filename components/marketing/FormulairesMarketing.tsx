              ...
              {champs.map((c, i) => (
                <div key={i} className="bg-slate-50 rounded-xl p-2 space-y-1.5">
                  <div className="flex items-center gap-2">
                    ...
                    <input value={c.label} onChange={(e) => majChamp(i, { label: e.target.value })} placeholder="Libellé" className="flex-1 px-2 py-1.5 border border-slate-200 rounded-lg text-xs min-w-0" />
