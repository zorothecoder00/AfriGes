...
function HistoriqueGlobal() {
  const { data, loading } = useApi<HistoriqueResponse>("/api/responsableRH/organigramme/historique?limit=15");
...
export default function OrganigrammePage() {
  ...
  const { data, loading, refetch } = useApi<OrgResponse>("/api/responsableRH/organigramme");
  ...
  }>("/api/responsableRH/organigramme", "PATCH");
