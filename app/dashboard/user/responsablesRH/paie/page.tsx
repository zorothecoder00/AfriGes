        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="shadow-sm bg-red-700 border-red-800 rounded-xl border p-4">
              ...
              <p className="text-2xl font-bold text-white">{fmt(data?.totalRetenues ?? 0)} FCFA</p>
            </div>
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="shadow-sm bg-red-700 border-red-800 rounded-xl border p-4">
              ...
              <p className="text-2xl font-bold text-white">{fmt(data?.totalSalariale ?? 0)} FCFA</p>
            </div>
            <div className="shadow-sm bg-orange-700 border-orange-800 rounded-xl border p-4">
              ...
              <p className="text-2xl font-bold text-white">{fmt(data?.totalPatronale ?? 0)} FCFA</p>
            </div>
            <div className="shadow-sm bg-amber-600 border-amber-700 rounded-xl border p-4">
              ...
              <p className="text-2xl font-bold text-white">{fmt(data?.totalCnss ?? 0)} FCFA</p>
            </div>
            <div className="shadow-sm bg-purple-700 border-purple-800 rounded-xl border p-4">
              ...
              <p className="text-2xl font-bold text-white">{fmt(data?.totalIrpp ?? 0)} FCFA</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-5">
              <div className="rounded-xl border bg-emerald-700 border-emerald-800 shadow-sm p-4">
                ...
                <p className="text-2xl font-bold text-white mt-1">{fmt(d.variables.commissions)} FCFA</p>
              </div>
              <div className="rounded-xl border bg-amber-600 border-amber-700 shadow-sm p-4">
                ...
                <p className="text-2xl font-bold text-white mt-1">{fmt(d.variables.bonus)} FCFA</p>
              </div>
              <div className="rounded-xl border bg-indigo-700 border-indigo-800 shadow-sm p-4">
                ...
                <p className="text-2xl font-bold text-white mt-1">{fmt(d.variables.primes)} FCFA</p>
              </div>
            </div>
