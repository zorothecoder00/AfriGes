    ...
    <div className="p-6 space-y-6 max-w-3xl mx-auto">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1.5">Part distribuée à l&apos;investisseur (%)</label>
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1.5">Part réinvestie automatiquement (%)</label>
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1.5">Fonds de sécurité (%)</label>
