...
export default function AuditFluxPage() {
  ...
  const { data, loading, refetch } = useApi<Data>("/api/membreCommission/audit-flux");
  ...
  const missionsBase = `/dashboard/user/responsablesRIA/gouvernance/commissions/${type}/missions`;
