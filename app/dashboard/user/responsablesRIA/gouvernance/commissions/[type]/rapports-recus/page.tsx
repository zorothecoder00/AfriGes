...
export default function RapportsRecusPage() {
  ...
  const { data, loading, refetch } = useApi<Data>("/api/membreCommission/optimisation-flux");
  ...
  const analysesBase = `/dashboard/user/responsablesRIA/gouvernance/commissions/${type}/analyses`;
