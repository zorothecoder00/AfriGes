...
export default function RecouvrementRIAPage() {
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="shadow-sm bg-blue-700 border-blue-800 rounded-xl border p-4">
          ...
          <div className="mt-2 h-1.5 bg-white/20 rounded-full overflow-hidden">
            <div className="h-full bg-white rounded-full" style={{ width: `${Math.min(100, stats.tauxRecouvrement)}%` }} />
          </div>
        </div>
                  ...
                  {financementsFiltres.map((f) => {
                    ...
                    return (
                      <tr key={f.id} className={`hover:bg-slate-50 ${f.niveauAlerte === "J30+" ? "bg-red-50/30" : ""}`}>
                        ...
                        <td className="px-4 py-3 text-center">
                          <button
                            onClick={() => setModalFin({ id: f.id, reference: f.reference, client: f.client.nom })}
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="shadow-sm bg-amber-600 border-amber-700 rounded-xl border p-4">
            ...
            <p className="text-2xl font-bold text-white mt-1">{pct(risques.tauxImpayes)}</p>
          ...
          <div className="shadow-sm bg-red-700 border-red-800 rounded-xl border p-4">
            ...
            <p className="text-2xl font-bold text-white mt-1">{fmt(risques.creancesDouteuses)}</p>
          ...
          <div className="shadow-sm bg-red-700 border-red-800 rounded-xl border p-4">
            ...
            <p className="text-2xl font-bold text-white mt-1">{fmt(risques.perteProbable)}</p>
