              ...
              <div key={c.typeCommission} className="bg-white rounded-xl border border-slate-200 overflow-hidden">
                <div className={`px-5 py-3 ${clr.bg} flex items-center justify-between`}>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <Link
                      href={`/dashboard/user/gouvernance/commissions/${enumToSlug(c.typeCommission as TypeCommissionRIA)}`}
                      className={`flex items-center gap-1 text-xs font-medium ${clr.text} hover:underline`}>
