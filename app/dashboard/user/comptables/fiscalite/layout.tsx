...
const BASE = "/dashboard/user/comptables/fiscalite";

const NAV_ITEMS = [
  { href: BASE,               exact: true, label: "TVA",    icon: Percent },
  { href: `${BASE}/taxes`,                 label: "Taxes",  icon: Landmark },
];
...
export default function FiscaliteLayout({ children }: { children: ReactNode }) {
