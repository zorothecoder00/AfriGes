...
export default function ComptablePage() {
  ...
  // ── État Import comptable générique (CSV) ─────────────────────────────
  ...
  }>(activeTab === "rapprochement" && releveCompteNumero ? `/api/comptable/rapprochement/lignes?compteNumero=${releveCompteNumero}` : null);
  ...
  // ── Import comptable générique (CSV) API ──────────────────────────────
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-['DM_Sans',sans-serif] lg:flex">
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        ...
        {/* ════════════════════════════════════════════════════════════════ */}
        {/* TAB : IMPORT COMPTABLE GÉNÉRIQUE                              */}
        {/* ════════════════════════════════════════════════════════════════ */}
        {activeTab === "importEcritures" && (
          <div className="space-y-4">
            <div className="bg-white rounded-2xl p-5 shadow-sm border border-slate-200/60">
              <h3 className="text-lg font-bold text-slate-800 flex items-center gap-2 mb-1">
                <Upload className="text-violet-600" size={20} /> Import comptable (CSV)
              </h3>
              <p className="text-xs text-slate-500 mb-4">
                    ...
                    <tbody className="divide-y divide-slate-50">
                      {apercuImport.groupes.map((g) => (
                        <tr key={g.reference} className={g.erreurs.length > 0 ? "bg-red-50/40" : ""}>
                          <td className="px-3 py-1.5 font-mono text-violet-700">{g.reference}</td>
