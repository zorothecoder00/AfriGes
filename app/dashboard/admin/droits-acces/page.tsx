...
const ROLE_LABELS: Record<string, { label: string; color: string }> = {
  ...
  CHEF_COMPTABLE:                      { label: "Chef comptable",                color: "bg-teal-50 text-teal-800 border-teal-300" },
  DIRECTEUR_GENERAL:                   { label: "Directeur général",             color: "bg-slate-50 text-slate-700 border-slate-200" },
  RESPONSABLE_ACHATS:                  { label: "Responsable achats",            color: "bg-orange-50 text-orange-800 border-orange-300" },
