        ...
        {stats && (
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
            <div className="bg-indigo-700 border-indigo-800 rounded-2xl border shadow-sm p-5 flex items-center gap-4">
              ...
              <div>
                <p className="text-xl sm:text-2xl leading-tight [overflow-wrap:anywhere] font-bold text-white">{stats.totalProduits}</p>
            ...
            <div className="bg-emerald-700 border-emerald-800 rounded-2xl border shadow-sm p-5 flex items-center gap-4">
              ...
              <div>
                <p className="text-xl sm:text-2xl leading-tight [overflow-wrap:anywhere] font-bold text-white">{stats.totalQuantite.toLocaleString("fr-FR")}</p>
            ...
            <div className="bg-amber-600 border-amber-700 rounded-2xl border shadow-sm p-5 flex items-center gap-4">
              ...
              <div>
                <p className="text-xl sm:text-2xl leading-tight [overflow-wrap:anywhere] font-bold text-white">{stats.totalPdvs}</p>
