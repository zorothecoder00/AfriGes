    ...
    <div className="md:p-6 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="shadow-sm bg-emerald-700 border-emerald-800 border rounded-xl p-4 text-center">
          <p className="text-xl sm:text-2xl leading-tight [overflow-wrap:anywhere] font-bold text-white">{stats?.actifs ?? 0}</p>
        ...
        <div className={`shadow-sm border rounded-xl p-4 text-center ${getStatCardHue(anomalies > 0 ? "bg-rose-50 border-rose-200" : "bg-white border-slate-200").solid}`}>
          <p className={`text-xl sm:text-2xl leading-tight [overflow-wrap:anywhere] font-bold ${anomalies > 0 ? "text-white" : "text-white"}`}>{anomalies}</p>
