    ...
    <div className="md:p-6 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="shadow-sm bg-blue-700 border-blue-800 border rounded-xl p-4 text-center">
          ...
          <p className="text-xl sm:text-2xl leading-tight [overflow-wrap:anywhere] font-bold text-white">{planifiees}</p>
        ...
        <div className="shadow-sm bg-emerald-700 border-emerald-800 border rounded-xl p-4 text-center">
          ...
          <p className="text-xl sm:text-2xl leading-tight [overflow-wrap:anywhere] font-bold text-white">{tenues}</p>
