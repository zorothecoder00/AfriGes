...
interface Region {
  ville: string; nbFinancements: number; totalFinance: number; totalRecouvre: number; rendement: number;
}
...
export default function BIPage() {
  ...
  const {
    kpis, top10Capital, top10Rentabilite, top10ClientsVolume, top10ClientsSolvabilite,
    topAgents, topRegions, previsionsTresorerie, encoursEchus, repartitionRisque, evolutionMensuelle,
  } = data;
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
          ...
          <SectionCard title="Prévisions trésorerie" icon={<Wallet className="w-4 h-4 text-blue-600" />}>
            <div className="p-5">
              ...
              <p className="text-xs text-slate-400 mt-4">
                Encours cumulatifs des financements actifs dont l&apos;échéance intervient avant chaque horizon.
              </p>
            </div>
          </SectionCard>
        </div>

        <SectionCard title="Scoring de risque" icon={<AlertTriangle className="w-4 h-4 text-orange-500" />}>
      ...
      {evolutionMensuelle.length > 0 && (
        <SectionCard title="Évolution des bénéfices — 12 mois" icon={<TrendingUp className="w-4 h-4 text-emerald-600" />}>
          <div className="p-5">
            <BarChart
