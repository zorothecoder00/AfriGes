      ...
      <div className="flex items-start justify-between gap-4">
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 flex-1">
          <div className="shadow-sm bg-indigo-700 border-indigo-800 rounded-xl border p-4 text-center">
            <p className={`text-2xl sm:text-3xl leading-tight [overflow-wrap:anywhere] font-bold text-white`}>{data.scoreMoyen}</p>
          ...
          <div className="shadow-sm bg-emerald-700 border-emerald-800 rounded-xl border p-4 text-center">
            <p className="text-2xl sm:text-3xl leading-tight [overflow-wrap:anywhere] font-bold text-white">{data.total}</p>
            <p className="text-xs text-white/80 mt-0.5">Clients scorés</p>
          </div>
          <div className="shadow-sm bg-emerald-700 border-emerald-800 rounded-xl border p-4 text-center">
            <p className="text-2xl sm:text-3xl leading-tight [overflow-wrap:anywhere] font-bold text-white">{data.repartition["Excellent"] ?? 0}</p>
