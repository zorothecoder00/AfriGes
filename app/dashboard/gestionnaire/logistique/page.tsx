...
function StatCard({ icon, value, label, sub, color, urgent }: {
  ...
  return (
    <div className={`group relative overflow-hidden ${urgent ? STAT_CARD_HUES.red.solid : h.solid} rounded-2xl border shadow-sm p-5 flex items-center gap-4 transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-xl`}>
      <div className={`w-12 h-12 rounded-xl flex items-center justify-center shrink-0 bg-white/20 text-white [&_svg]:text-white transition-transform duration-300 ease-out group-hover:scale-110`}>{icon}</div>
      <div>
