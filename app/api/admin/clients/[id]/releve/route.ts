...
/**
 * GET /api/admin/clients/[id]/releve?dateDebut=&dateFin=
 * Relevé de compte client (CDC digitalisation §5.4 / CDC Comptabilité §16) —
 * même moteur que le relevé comptable (lib/comptabilite/clientAuxiliaire.ts),
 * ouvert ici à l'admin (accès déjà total, pas de garde de périmètre nécessaire).
 */
export async function GET(req: Request, { params }: Ctx) {
  try {
    ...
    console.error("GET /admin/clients/[id]/releve:", e);
