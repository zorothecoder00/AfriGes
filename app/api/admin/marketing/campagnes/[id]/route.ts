...
/**
 * Alerte stock (CDC §61) : pour chaque produit ciblé (ou famille expansée) ×
 * chaque agence ciblée, compare le stock disponible au seuil d'alerte.
 */
async function calculerAlertesStock(campagneId: number) {
