...
/**
 * POST /api/caissier/credits/[id]/rembourser
 * Body: { montant, modePaiement?, notes? }
 *
 * Enregistre un remboursement de crédit au comptoir.
 * Scoped au PDV du caissier. Même logique d'imputation que la route admin.
 */
export async function POST(req: Request, { params }: Ctx) {
  try {
    ...
    console.error("POST /api/caissier/credits/[id]/rembourser error:", error);
