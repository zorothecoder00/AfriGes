...
/**
 * GET /api/rvc/clients/[id]/releve?dateDebut=&dateFin=
 * Relevé de compte client (CDC digitalisation §5.4), scoped PDV — même moteur
 * que le relevé comptable (lib/comptabilite/clientAuxiliaire.ts).
 */
export async function GET(req: Request, { params }: Ctx) {
  try {
    ...
    console.error("GET /rvc/clients/[id]/releve:", e);
