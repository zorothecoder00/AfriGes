...
/**
 * GET /api/responsableRH/formations/plans
...
export async function GET() {
  try {
    ...
    console.error("GET /api/responsableRH/formations/plans", error);
    return NextResponse.json({ error: "Erreur serveur" }, { status: 500 });
  }
}

/**
 * POST /api/responsableRH/formations/plans
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error("POST /api/responsableRH/formations/plans", error);
    return NextResponse.json({ error: "Erreur serveur" }, { status: 500 });
  }
}
