...
/**
 * GET /api/responsableRH/formations
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("GET /api/responsableRH/formations", error);
    return NextResponse.json({ error: "Erreur serveur" }, { status: 500 });
  }
}

/**
 * POST /api/responsableRH/formations
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error("POST /api/responsableRH/formations", error);
    return NextResponse.json({ error: "Erreur serveur" }, { status: 500 });
  }
}
