...
/**
 * GET /api/responsableRH/paie/retenues — État des retenues, scopé au périmètre PDV.
 * Même agrégat que /api/admin/rh/paie/retenues (cf. ce fichier pour le détail).
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("GET /api/responsableRH/paie/retenues", error);
