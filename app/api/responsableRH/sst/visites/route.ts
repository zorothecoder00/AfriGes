...
/**
 * GET /api/responsableRH/sst/visites
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("GET /api/responsableRH/sst/visites", error);
    return NextResponse.json({ error: "Erreur serveur" }, { status: 500 });
  }
}

/**
 * POST /api/responsableRH/sst/visites
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error("POST /api/responsableRH/sst/visites", error);
    return NextResponse.json({ error: "Erreur serveur" }, { status: 500 });
  }
}
