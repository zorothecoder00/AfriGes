...
/**
 * GET /api/responsableRH/sst/incidents
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("GET /api/responsableRH/sst/incidents", error);
    return NextResponse.json({ error: "Erreur serveur" }, { status: 500 });
  }
}

/**
 * POST /api/responsableRH/sst/incidents
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error("POST /api/responsableRH/sst/incidents", error);
    return NextResponse.json({ error: "Erreur serveur" }, { status: 500 });
  }
}
