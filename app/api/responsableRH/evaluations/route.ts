...
/**
 * GET /api/responsableRH/evaluations
...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("GET /api/responsableRH/evaluations", error);
    return NextResponse.json({ error: "Erreur serveur" }, { status: 500 });
  }
}

/**
 * POST /api/responsableRH/evaluations
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error("POST /api/responsableRH/evaluations", error);
    return NextResponse.json({ error: "Erreur serveur" }, { status: 500 });
  }
}
