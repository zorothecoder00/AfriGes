...
export const CATALOGUE_DOCUMENTS: EntreeCatalogue[] = [
  ...
  },
  {
    ...
    roles: ["Agent terrain", "Commercial", "Magasinier", "RVC", "RPV", "Admin"],
    rolesGestionnaire: ["AGENT_TERRAIN", "COMMERCIAL", "MAGAZINIER", "RESPONSABLE_VENTE_CREDIT", "RESPONSABLE_POINT_DE_VENTE"],
    pageUrl: "/dashboard/user/agentsTerrain/commandes-client",
    pageUrlAdmin: "/dashboard/admin/commandes-client",
    pageUrlParRole: {
      RESPONSABLE_VENTE_CREDIT: "/dashboard/user/responsablesVenteCredit/commandes-client",
      RESPONSABLE_POINT_DE_VENTE: "/dashboard/user/responsablesVenteCredit/commandes-client",
    },
  },
  {
    id: "bcf",
  ...
  },
  {
    id: "bci",
    module: "§5.3",
    titre: "Bon de commande interne (réapprovisionnement)",
    description: "Demande de réapprovisionnement du magasinier, du RPV ou du chef d'agence vers l'approvisionnement central : validation agence, validation centrale, prise en charge, clôture.",
    roles: ["Magasinier", "RPV", "Chef d'agence", "Agent Logistique/Approvisionnement", "Admin"],
    rolesGestionnaire: ["MAGAZINIER", "RESPONSABLE_POINT_DE_VENTE", "CHEF_AGENCE", "AGENT_LOGISTIQUE_APPROVISIONNEMENT"],
    pageUrl: "/dashboard/user/logistiquesApprovisionnements/commandes-internes",
    pageUrlAdmin: "/dashboard/admin/commandes-internes",
    pageUrlParRole: {
