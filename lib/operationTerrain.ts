...
/**
 * Opérations marketing terrain (CDC §41) — street marketing, flyers,
 * porte-à-porte, animation marché, dégustation, stand, caravane. Toujours
 * rattachée à une Campagne existante (réutilise budget/dates/agences déjà
 * portés par Campagne, Phase 1) ; les résultats (prospects/clients/CA) sont
 * saisis par le staff en fin d'opération — pas de capture de lead unitaire
 * sur le terrain, contrairement aux formulaires/QR (simplification assumée).
 */
